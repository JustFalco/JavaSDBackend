...
class EmailValidationTest {
    ...
    @Test
    void testValidate() {
        assertTrue(this.emailValidation.validate("jane.doe@example.org", "Not all who wander are lost"));
        assertTrue(this.emailValidation.validate("l.l.l@lll.lll.lll.lll", "Not all who wander are lost"));
